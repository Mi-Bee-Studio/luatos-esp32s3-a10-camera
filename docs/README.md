# MiBeeCam Documentation

> Bilingual documentation for the MiBeeCam ESP32-S3-A10 smart camera system.

## 🌐 Languages

| Language | Directory |
|----------|-----------|
| 中文 | [docs/zh-CN/](zh-CN/README.md) |
...
| Document | 中文 | English |
|----------|------|---------|
| Hardware Specs | [hardware.md](zh-CN/hardware.md) | [hardware.md](en/hardware.md) |
